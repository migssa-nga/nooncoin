...
public:
    CMainParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.nooncoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("nooncointools.com", "dnsseed.nooncointools.com"));
        //vSeeds.push_back(CDNSSeedData("nooncoinpool.org", "dnsseed.nooncoinpool.org"));
        //vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        vSeeds.push_back(CDNSSeedData("seed.nooncurrency.com", "seed.nooncurrency.com"));
        vSeeds.push_back(CDNSSeedData("seed2.nooncurrency.com", "seed2.nooncurrency.com"));
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("nooncointools.com", "testnet-seed.nooncointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.nooncoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("seed.test-nooncurrency.com", "seed.test-nooncurrency.com"));
        vSeeds.push_back(CDNSSeedData("seed.test-nooncurrency.com", "seed.test-nooncurrency.com"));
        ...
        vFixedSeeds.push_back(lookupDomain("seed3.nooncurrency.com",nDefaultPort));
        vFixedSeeds.push_back(lookupDomain("seed2.nooncurrency.com",nDefaultPort));
        vFixedSeeds.push_back(lookupDomain("seed1.nooncurrency.com",nDefaultPort));
