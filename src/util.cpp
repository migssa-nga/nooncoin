...
const char * const BITCOIN_CONF_FILENAME = "nooncoin.conf";
const char * const BITCOIN_PID_FILENAME = "nooncoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nooncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nooncoin";
#else
    // Unix
    return pathRet / ".nooncoin";
#endif
#endif
}
