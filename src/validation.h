...
/** Default for DEFAULT_WHITNOONSTRELAY. */
static const bool DEFAULT_WHITNOONSTRELAY = true;
/** Default for DEFAULT_WHITNOONSTFORCERELAY. */
static const bool DEFAULT_WHITNOONSTFORCERELAY = true;
