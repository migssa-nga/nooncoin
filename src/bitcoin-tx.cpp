...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nooncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nooncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nooncoin transaction") + "\n" +
              "  nooncoin-tx [options] -create [commands]   " + _("Create hex-encoded nooncoin transaction") + "\n" +
              "\n";
